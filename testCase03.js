...
async function start() {
    let driver = await new Builder().forBrowser(Browser.CHROME).build();
        ...
        await driver.findElement(By.id('txt-username')).sendKeys('Incorrect Username');
        await driver.findElement(By.id('txt-password')).sendKeys('Incorrect Password');
        ...
        console.log("Login with incorrect username and incorrect password, passed");
        await driver.quit();
}
